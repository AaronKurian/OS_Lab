...
void calculateTimes(struct Process processes[], int n) {
    int current_time = 0;
    int completed = 0;
    int timeline[100] = {0}; // For Gantt chart
    int process_order[100] = {0}; // For Gantt chart
    int time_points[100] = {0}; // For Gantt chart
    int chart_index = 0;
    ...
    while (completed < n) {
        ...
        timeline[chart_index] = current_time;
        process_order[chart_index] = processes[shortest_job].pid;
        chart_index++;
